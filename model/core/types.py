...
class NDGNode:
    ...
    evidence_sources: Optional[List[Dict]] = None  # List of {"type": "Quantitative/Qualitative/External", "description": str, "freshness": str}
    evidence_strength: float = 0.0  # 0-1: how well supported
    contradicting_evidence: Optional[List[str]] = None  # Evidence that challenges this claim
